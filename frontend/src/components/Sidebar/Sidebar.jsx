...
function Sidebar(){
    ...
    const menuItems = [
        ...
        { path: "/depots", label: "Depots", icon: "🏭", section: "Fleet" },
        ...
        { path: "/incidents", label: "Incidents", icon: "🚨", section: "Monitoring" },
        
        { path: "/maintenance", label: "Maintenance", icon: "🔧", section: "Operations" },
        { path: "/work-orders", label: "Work Orders", icon: "📋", section: "Operations" },
        { path: "/documents", label: "Documents", icon: "📄", section: "Operations" },
        { path: "/analytics", label: "Analytics", icon: "📈", section: "Operations" },
        { path: "/cost-analytics", label: "Cost Analytics", icon: "💰", section: "Operations" },
        { path: "/reports", label: "Reports", icon: "📄", section: "Operations" },
        
        { path: "/voice-ai", label: "AI Assistant", icon: "🤖", section: "Intelligence" },
        { path: "/audit-log", label: "Audit Log", icon: "📋", section: "System" },
